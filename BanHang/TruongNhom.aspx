...
<body onmousemove="ResetTimers();" onunload="Leave();">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="True"
        ...
        <Scripts>
            ...
            <asp:ScriptReference Path="../js/m.bh.tn.js" />
        </Scripts>
    </asp:ScriptManager>
    ...
    <div class="container">
        ...
        <div class="row">
            <div style="float: left">
                <asp:DropDownList ID="drBanYCTT" runat="server" CssClass="form form-control">
                </asp:DropDownList>
            </div>
            <div style="float: left; margin-left: 10px;">
                <input id="btnInTrucTiep" onclick="InClick()" type="button" value="IN PHIẾU" style="width: 70px"

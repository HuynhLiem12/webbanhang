<%@ Page Title="PHIEU THU" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PhieuThu.aspx.cs" Inherits="NhaHang.ThuChi.PhieuThu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    // <![CDATA[
        ...
        function RowClickHandlerLp(s, e) {
            ...
            var s = gvLoaiPhieu.cpTenPhieuThu[e.visibleIndex];
            var r = s.split(";");
        ...
        function UpdateEditBoxLp() {
            ...
            var focusedTenPhieuThu = rowIndex == -1 ? "" : gvLoaiPhieu.cpTenPhieuThu[rowIndex];
            var TenPhieuThuInEditBox = drLoaiPhieu.GetText();
            if (TenPhieuThuInEditBox != focusedTenPhieuThu)
                DropDownEdit.SetText(focusedTenPhieuThu);
        }
    // ]]> 
    </script>
</asp:Content>
            ...
            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                <table style="text-align: left">
                    <tr>
                        ...
                        <td>
                            <dx:ASPxLabel ID="lbSoPhieuThu" runat="server">
                            </dx:ASPxLabel>
                        </td>
                        <td>
                            LOẠI PHIẾU THU:
                        ...
                        <td>
                            <dx:ASPxDropDownEdit ID="drLoaiPhieu" runat="server" Width="121px" ClientInstanceName="drLoaiPhieu"
                                ...
                                <DropDownWindowTemplate>
                                    <dx:ASPxGridView ID="gvLoaiPhieu" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvLoaiPhieu"
                                        DataSourceID="lqLoaiPhieu" KeyFieldName="LoaiPhieuThuId" OnAfterPerformCallback="gvLoaiPhieu_AfterPerformCallback"
                                        OnCustomJSProperties="gvLoaiPhieu_CustomJSProperties" OnInitNewRow="GridView_InitNewRow"
                                        OnRowInserting="gvLoaiPhieu_RowInserting" Theme="RedWine" Width="300px">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="LoaiPhieuThuId" VisibleIndex="0" Width="70px">
                                                <PropertiesTextEdit Width="70px">
                                                </PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="TenPhieuThu" VisibleIndex="1" Width="150px">
                            ...
                            <asp:LinqDataSource ID="lqLoaiPhieu" runat="server" ContextTypeName="NhaHangSql.ThuChiDataContext"
                                ...
                                TableName="DMLoaiPhieuThus" StoreOriginalValuesInViewState="False">
                            </asp:LinqDataSource>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="float: left">
                            <dx:ASPxDateEdit ID="dNgayChi" runat="server" Theme="RedWine">
                    ...
                    <tr>
                        ...
                        <td style="float: left">
                            <dx:ASPxDropDownEdit ID="DropDownEdit" runat="server" ClientInstanceName="DropDownEdit"
                                Width="170px" AllowUserInput="False" EnableAnimation="False" Theme="RedWine">
                                <DropDownWindowStyle>
                                ...
                                <DropDownWindowTemplate>
                                    <dx:ASPxGridView ID="GridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridView"
                                        ...
                                        OnAfterPerformCallback="GridView_AfterPerformCallback" Theme="RedWine">
